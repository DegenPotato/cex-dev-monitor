...
const migrations = [
  ...
  // Backfill NULL last_verified values (set to discovered_at for existing pools)
  `UPDATE token_pools SET last_verified = discovered_at WHERE last_verified IS NULL`
];
