 ...
 */
router.get('/api/realtime-ohlcv/subscription', authService.requireSecureAuth(), async (req, res) => {
    try {
 ...
 */
router.get('/api/realtime-ohlcv/active', authService.requireSuperAdmin(), async (_req, res) => {
    try {
        // Get from service
 ...
 */
router.get('/api/realtime-ohlcv/history', authService.requireSecureAuth(), async (req, res) => {
    try {
        const userId = req.user.id;
