...
(function (ActivityType) {
    ...
    ActivityType["ADD_LIQUIDITY"] = "ADD_LIQUIDITY";
    ActivityType["REMOVE_LIQUIDITY"] = "REMOVE_LIQUIDITY";
...
export class DefiActivityAnalyzer {
    ...
    determineActivityType(tx, program) {
     ...
     */
    async analyzeWallet(connection, walletAddress, limit = 1000) {
        ...
        try {
            ...
            const stats = {
                ...
                liquidityOps: activities.filter(a => a.type === ActivityType.ADD_LIQUIDITY || a.type === ActivityType.REMOVE_LIQUIDITY).length,
                programUsage,
