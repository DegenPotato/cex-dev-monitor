...
export class YouTubeAccountProvider {
   ...
   */
  static async saveAccount(account: YouTubeAccount): Promise<YouTubeAccount> {
    await execute(`
   ...
   */
  static async updateToken(accountId: number, accessToken: string, expiresAt: string): Promise<void> {
    await execute(`
   ...
   */
  static isTokenExpired(account: YouTubeAccount): boolean {
   ...
   */
  static async revokeAccount(accountId: number): Promise<void> {
    await execute(`
      UPDATE user_youtube_accounts 
   ...
   * Save playlist cache
   */
  static async savePlaylist(playlist: YouTubePlaylist): Promise<void> {
    await execute(`
   ...
   */
  static async getPlaylists(youtubeAccountId: number): Promise<YouTubePlaylist[]> {
    return await queryAll<YouTubePlaylist>(`
   ...
   */
  static async clearPlaylists(youtubeAccountId: number): Promise<void> {
