  ...
  try {
    ...
    let query = `
      SELECT 
        ...
        t.priority_fee_sol as fee,
        t.tax_amount_sol as taxAmount,
        t.net_amount_sol as netAmount,
        t.total_fee_sol as totalFee,
        t.token_price_usd as tokenPriceUsd,
        t.sol_price_usd as solPriceUsd,
        t.total_value_usd as totalValueUsd,
        t.price_impact_pct as priceImpact,
    ...
    const formatted = trades.map((t: any) => ({
      ...
      tokenPriceUsd: t.tokenPriceUsd || 0,
      solPriceUsd: t.solPriceUsd || 0,
      totalValueUsd: t.totalValueUsd || 0,
